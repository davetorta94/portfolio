  ...
  return (
    ...
    variants={{
      ...
      transition={ {ease: "easeOut", duration: 1} }>
        ...
        <div className="row fondo-hor text-white d-flex justify-content-around mt-2 mb-5 pt-2 sombrita animate__animated animate__slideInDown" id="sobremi">
        ...
        <div className="row fondo-card text-white justify-content-center mt-2 sombrita animate__animated animate__slideInDown sombrita">
          <div className="col-1">
